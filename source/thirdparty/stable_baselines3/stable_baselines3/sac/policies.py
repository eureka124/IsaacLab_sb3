...
from stable_baselines3.common.torch_layers import (
    ...
    MY_CombinedExtractor,
    TeacherCombinedExtractor,
)
...
class MultiInputPolicy(SACPolicy):
    ...
    def __init__(
        ...
        use_expln: bool = False,
        clip_mean: float = 2.0,
        features_extractor_class: type[BaseFeaturesExtractor] = TeacherCombinedExtractor,
        features_extractor_kwargs: dict[str, Any] | None = None,
        normalize_images: bool = True,
        optimizer_class: type[th.optim.Optimizer] = th.optim.Adam,
        optimizer_kwargs: dict[str, Any] | None = None,
...
class ExpertMultiInputPolicy(SACPolicy):
    """
    Policy class (with both actor and critic) for SAC.
    ...
    def __init__(
        ...
        use_expln: bool = False,
        clip_mean: float = 2.0,
        features_extractor_class: type[BaseFeaturesExtractor] = MY_CombinedExtractor,
        features_extractor_kwargs: dict[str, Any] | None = None,
        normalize_images: bool = True,
        optimizer_class: type[th.optim.Optimizer] = th.optim.Adam,
        optimizer_kwargs: dict[str, Any] | None = None,
